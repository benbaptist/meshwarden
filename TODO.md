...
- individual Contact page improvements
    ...
    - Repeater admin overhaul
        ...
        - For mobile viewports, this is a separate page with a button to access it; for desktop-viewports, let's just utilize the currently-unused right panel as the admin panel, always visible, starting with login
        - Auth overhaul: 
            ...
            - Auth should be remembered by the node/whatever handles it until it needs to be expired for one reason or another
            - Login password thing shoudl be centered vertically and horizontally and look nice
