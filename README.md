...
MeshWarden is a web-based dashboard for managing [MeshCore](https://github.com/meshcore-dev/MeshCore) nodes. It gives you a single place to watch your mesh network in real time — seeing who's out there, how well you're hearing them, and what they're saying — while also letting you actively manage and automate interactions with contacts across one or more nodes.
